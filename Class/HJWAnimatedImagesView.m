...
@interface HJWAnimatedImagesView ()
{
    BOOL animating;
...
@implementation HJWAnimatedImagesView
...
- (NSTimeInterval)timePerImage {
    if (_timePerImage == 0) {
        return hjw_AnimatedImagesViewDefaultTimePerImage;
    }
    
    return _timePerImage;
}

- (void)setDelegate:(id<hjw_AnimatedImagesViewDelegate>)delegate {
